    ...
    <div className="landingPage">
      <div className="landingHero">
        ...
        <div className="landingHero-title">
          <h1 className="banner-h1">Start an amazing journey with seamless flight booking!</h1>
          <p className="banner-p">Turn your travel dreams into reality by booking amazing flights to unforgettable destinations.</p>
        </div>
